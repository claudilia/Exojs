...
for (montant ; montant <= 2000; montant += 50) {
	document.write(`<p style='color:blue'> tout les mois j'ai : ${montant}</p>`);
}

document.write(`<p>j'ai economisé pendant 21 mois pour atteindre 2000€</p>`)
